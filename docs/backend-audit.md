...
profile-v0 canonical-encoding and bounded serial vector-commitment research
...
profile-bound root decoding, the internal profile-v0 commitment engine, the
...
profile-v0 implementation does not claim to hide key, value, vector-sparsity,
...
research profile v0 and the package-owned internal unverified tree-proof
...
behavior. The engine therefore remains a profile-v0 internal component
