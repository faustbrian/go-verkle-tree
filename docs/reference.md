...
This document contains the detailed package contracts and operational notes.
Start with the root README and documentation index.

## Status

This module has a stable v1 Go API around the package-owned research profile
`verkletree-bandersnatch-ipa-256-v0`. Its root package exposes
...
interrupted unpublished write. The implementation rebuilds the complete tree
for stateful updates, persisted loads, and maintained publications, and
provides canonical
...
- [Usage and error handling](usage.md)
- [Storage, recovery, pruning, and adapter crash testing](storage-operations.md)
- [Adoption, migration, and FAQ](adoption.md)
- [API and ownership boundaries](api-boundaries.md)
- [Threat model](threat-model.md)
- [Compatibility matrix](compatibility.md)
- [Specification decisions](specification-decisions.md)
- [Backend audit](backend-audit.md)
- [Platform and CPU audit](platforms.md)
- [Benchmark method and raw samples](benchmarks.md)
